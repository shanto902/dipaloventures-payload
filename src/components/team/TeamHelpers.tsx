...
export function OrgPill({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`inline-flex items-center gap-1 border border-neutral-200 text-neutral-800 hover:text-[#ffb012] hover:border-[#ffb012] transition-colors ${
      ...
      <div className="flex flex-col flex-1 min-w-0 border-t border-neutral-200 p-5">
        ...
        {hasMore && (
          <button
            ...
            onClick={() => setOpen((o) => !o)}
            aria-expanded={open}
            className="mt-2.5 self-start inline-flex items-center gap-1 font-mono text-sm uppercase tracking-widest text-[#ffb012] hover:text-amber-700 transition-colors font-bold"
          >
