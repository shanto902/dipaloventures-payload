...
function GPCard({ m }: { m: TeamMember & { orgLinks?: OrgLink[] } }) {
  ...
  return (
    <article className="group relative bg-white border border-neutral-100 rounded-[2rem] p-6 flex flex-col sm:flex-row gap-6 lg:gap-8 transition-all duration-500 hover:shadow-xl hover:shadow-neutral-900/5 hover:-translate-y-1">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="font-mono uppercase  text-xs tracking-[0.2em] text-neutral-400 font-bold">
          {m.role} · {m.location}
        </div>
...
export function TeamGPs({ members }: { members?: TeamMember[] }) {
  ...
  return (
    <section className="relative px-5 md:px-12 py-12 md:pb-24 overflow-hidden bg-[#fcfbf9]">
