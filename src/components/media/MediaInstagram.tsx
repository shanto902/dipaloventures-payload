      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl md:text-5xl font-semibold text-neutral-900 leading-tight tracking-tight">
              Reports from <br />
              the <span className="italic text-amber-400 ">field.</span>
            </h2>
          </div>
        ...
        <div className="mt-16 flex justify-center">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group inline-flex items-center gap-4 px-8 py-4 bg-white border border-neutral-100 rounded-full font-mono  text-xs uppercase tracking-[0.3em] text-amber-400 hover:text-amber-500 shadow-sm hover:shadow-xl hover:shadow-neutral-900/5 transition-all duration-500 font-bold"
          >
            <span>Follow @dipaloventures</span>
            <span className="w-8 h-px bg-amber-400/20 group-hover:w-12 transition-all duration-500" />
            <span>↗</span>
          </a>
        </div>
      </div>
