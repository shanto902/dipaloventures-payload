...
const socialCards = [
  {
    name: 'LinkedIn',
    desc: 'Firm updates & hiring.',
    href: socialLinks.linkedin,
    Icon: LinkedInLogo,
  },
  { name: 'YouTube', desc: 'Founder conversations.', href: socialLinks.youtube, Icon: YouTubeLogo },
  {
    name: 'Instagram',
  ...
  { name: 'Medium', desc: 'Long-form essays.', href: socialLinks.medium, Icon: MediumLogo },
]

export function MediaSocialConnect() {
  return (
    <section className="py-16 bg-[#F5F0E8] border-b border-[#d4c9b0]">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-xl mx-auto text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-serif text-neutral-900 font-medium mb-4">
            Quarterly notes on deep tech.
          </h2>
          <p className="text-base text-neutral-500 mb-8 leading-relaxed">
            Subscribe to get our honest takes on manufacturing, physical AI, and the founders we
            back.
          </p>
          <div className="flex justify-center">
            <NewsletterForm />
          </div>
          <p className="mt-4 text-sm text-neutral-400 font-medium italic">
            Direct from our Substack to your inbox.
          </p>
        </div>
      </div>
    </section>
