...
export function ContactForm() {
  ...
  return (
    <div className="bg-[#fcfbf9] rounded-3xl p-6 md:p-10 relative overflow-hidden group">
      ...
      <div className="relative z-10 flex flex-col gap-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex p-1 bg-white/50 rounded-full border border-neutral-100">
            {(['general', 'founder', 'investor'] as InquiryType[]).map((type) => (
              <button
                ...
                className={`
                  flex-1 py-3 rounded-full text-xs font-mono uppercase tracking-widest font-bold transition-all duration-300
                  ${
                    inquiryType === type
                      ? 'bg-[#ffb012] text-black shadow-sm'
          ...
          <div className="pt-4 flex flex-col gap-6">
            <button
              ...
              className="group relative w-fit px-12 bg-neutral-900 text-white py-5 rounded-full font-mono text-xs uppercase tracking-[0.3em] font-bold hover:bg-neutral-800 transition-all duration-500 overflow-hidden disabled:opacity-50"
            >
