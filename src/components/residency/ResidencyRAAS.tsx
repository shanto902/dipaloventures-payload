    ...
    <section id="services" className="bg-neutral-100 py-24 border-y border-neutral-200">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
          <div>
            <div className="text-sm font-semibold uppercase tracking-widest text-neutral-500 mb-3">New offering</div>
            ...
            <p className="mt-5 text-lg text-neutral-600 leading-relaxed">
              ...
              operator-grade engineering and supply chain support. RAAS extends Residency
              to companies, corporates, and co-investors as a standalone engagement.
            </p>
            <Link
              href="/contact"
              className="mt-8 inline-flex px-6 py-3 bg-amber-600 text-white font-medium rounded-md hover:bg-amber-700 transition-colors"
            >
              Engage Residency →
            </Link>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {raasCards.map((x) => (
              <article key={x.t} className="bg-white border border-neutral-200 p-6 rounded-xl shadow-sm">
