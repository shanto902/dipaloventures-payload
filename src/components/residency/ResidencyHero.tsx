  ...
  return (
    <section className="container mx-auto px-4 py-12 md:py-16">
      <div className="max-w-3xl">
        <div className="text-sm font-semibold uppercase tracking-widest text-neutral-500 mb-4">The Residency</div>
      ...
      <div className="mt-16 grid lg:grid-cols-2 gap-6">
        <figure className="bg-neutral-100 border border-neutral-200 p-10 rounded-xl">
          <blockquote className="font-serif text-2xl leading-snug text-neutral-900">
            "There's a tremendous amount of <span className="italic">craftsmanship</span> in
            between a great idea and a great product."
          </blockquote>
          <figcaption className="mt-6 font-mono text-xs uppercase tracking-widest text-amber-600 font-semibold">
            — Dipalo Ventures
          </figcaption>
        </figure>
        <div className="bg-white border border-neutral-200 p-8 rounded-xl shadow-sm">
          <div className="font-mono text-xs uppercase tracking-widest text-amber-600 font-semibold">The Result</div>
          <p className="mt-4 text-neutral-600 leading-relaxed">
            Residency surfaces gaps in engineering, supply chain, and time-to-market before
            they become existential — so founders can solve them while there's still runway.
          </p>
        </div>
      </div>
    </section>
