      ...
      <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
        <div>
          ...
          <p className="mt-5 text-lg text-neutral-600 leading-relaxed">
            Residency isn't an accelerator and it isn't advisory hours. It's operators embedded with
            your team, doing the technical work alongside you — from early design reviews to your
            first production runs.
          </p>
          <Link
            href="/team"
            className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-amber-400 hover:text-amber-700 hover:underline underline-offset-4"
          >
